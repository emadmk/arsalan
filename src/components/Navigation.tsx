      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link to="/signup">
              <Button
                className="bg-carpet-antique-gold text-carpet-black hover:bg-carpet-antique-gold/90"
              >
                ثبت نام
              </Button>
            </Link>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-2 border-t border-carpet-antique-gold/20 glass-dark">
              ...
              <Link to="/login" className="block" onClick={() => setIsOpen(false)}>
                <Button
                  variant="ghost"
                  className="w-full text-carpet-cream hover:text-carpet-antique-gold justify-start"
                >
                  <User className="w-4 h-4 ml-2" />
                  ورود
                </Button>
              ...
              <Link to="/signup" className="block" onClick={() => setIsOpen(false)}>
                <Button
                  className="w-full bg-carpet-antique-gold text-carpet-black hover:bg-carpet-antique-gold/90"
                >
                  ثبت نام
                </Button>
              </Link>
